...
var verbs, nouns, adjectives, adverbs, preposition;
            ...
            function sentence() {
              ...
              var content = preposition2[rand1] + " the " + adjectives[rand1] + " " + nouns[rand2] + " " + adverbs[rand3] + ", we have " + verbs[rand4] + " " + nouns[rand1] + ", " + adverbs[rand1] + " " + verbs[rand1] + " " + preposition[rand2] + " " + adjectives[rand2] + " " + nouns[rand5] + " " + adjectives[rand3] + " " + adjectives[rand4] + " " + nouns[rand6] + "." + gameQ[rand7];
              */
              var content = gameQ[rand7];
